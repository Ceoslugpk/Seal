...
class PlayerViewModelTest {
    ...
    private val libVLC: LibVLC = mock()
    ...
    @Test
    fun `seek should update media player time`() {
        viewModel.seek(1000L)
        verify(mediaPlayer).time = 1000L
    }

    @Test
    fun `seekTo should update media player time`() {
    ...
    @Test
    fun `changeVolume should update media player volume`() {
